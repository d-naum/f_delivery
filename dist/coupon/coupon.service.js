...
let CouponService = class CouponService {
    constructor(couponRepository, clientRepository) {
    ...
    async createCoupon(coupon) {
        ...
        if (!results) {
            ...
            return Object.assign(Object.assign({}, saveCoupon), { client: results });
        }
    }
    async getCoupons() {
    ...
    async getClientCoupon(id) {
        const results = await this.couponRepository
            ...
            .getMany();
        if (!results) {
            throw new common_1.NotFoundException('No Coupon found');
        }
        return results;
    }
};
